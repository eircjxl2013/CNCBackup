...
public class OffsetSettingModule : MonoBehaviour {
	...
	void ArguSettings () {
		...
		GUI.Label(new Rect(40f/1000f*Main.width,60f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"写参数", Main.sty_MostWords);
		GUI.Label(new Rect(220f/1000f*Main.width,60f/1000f*Main.height,20f/1000f*Main.width,300f/1000f*Main.height),"=", Main.sty_MostWords);
		GUI.Label(new Rect(240f/1000f*Main.width,60f/1000f*Main.height,20f/1000f*Main.width,29f/1000f*Main.height),"", Main.sty_OffSet_Coo_mini);
		GUI.Label(new Rect(270f/1000f*Main.width,60f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"(0：不可以  1：可以)", Main.sty_MostWords);
		GUI.Label(new Rect(40f/1000f*Main.width,90f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"TV  检查", Main.sty_MostWords);
		GUI.Label(new Rect(220f/1000f*Main.width,90f/1000f*Main.height,20f/1000f*Main.width,300f/1000f*Main.height),"=", Main.sty_MostWords);
		GUI.Label(new Rect(240f/1000f*Main.width,90f/1000f*Main.height,20f/1000f*Main.width,29f/1000f*Main.height),"", Main.sty_OffSet_Coo_mini);
		GUI.Label(new Rect(270f/1000f*Main.width,90f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"(0：关断  1：接通)", Main.sty_MostWords);
		GUI.Label(new Rect(40f/1000f*Main.width,120f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"穿孔代码", Main.sty_MostWords);
		GUI.Label(new Rect(220f/1000f*Main.width,120f/1000f*Main.height,20f/1000f*Main.width,300f/1000f*Main.height),"=", Main.sty_MostWords);
		GUI.Label(new Rect(240f/1000f*Main.width,120f/1000f*Main.height,20f/1000f*Main.width,29f/1000f*Main.height),"", Main.sty_OffSet_Coo_mini);
		GUI.Label(new Rect(270f/1000f*Main.width,120f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"(0：EIA  1：ISO)", Main.sty_MostWords);
		GUI.Label(new Rect(40f/1000f*Main.width,150f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"输入单位", Main.sty_MostWords);
		GUI.Label(new Rect(220f/1000f*Main.width,150f/1000f*Main.height,20f/1000f*Main.width,300f/1000f*Main.height),"=", Main.sty_MostWords);
		GUI.Label(new Rect(240f/1000f*Main.width,150f/1000f*Main.height,20f/1000f*Main.width,29f/1000f*Main.height),"", Main.sty_OffSet_Coo_mini);
		GUI.Label(new Rect(270f/1000f*Main.width,150f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"(0：毫米  1：英寸)", Main.sty_MostWords);
		GUI.Label(new Rect(40f/1000f*Main.width,180f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"I/O  通道", Main.sty_MostWords);
		GUI.Label(new Rect(220f/1000f*Main.width,180f/1000f*Main.height,20f/1000f*Main.width,300f/1000f*Main.height),"=", Main.sty_MostWords);
		GUI.Label(new Rect(240f/1000f*Main.width,180f/1000f*Main.height,40f/1000f*Main.width,29f/1000f*Main.height),"", Main.sty_OffSet_Coo_mid);
		GUI.Label(new Rect(290f/1000f*Main.width,180f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"(0-35：  通道号 )", Main.sty_MostWords);
		GUI.Label(new Rect(40f/1000f*Main.width,210f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"顺序号", Main.sty_MostWords);
		GUI.Label(new Rect(220f/1000f*Main.width,210f/1000f*Main.height,20f/1000f*Main.width,300f/1000f*Main.height),"=", Main.sty_MostWords);
		GUI.Label(new Rect(240f/1000f*Main.width,210f/1000f*Main.height,20f/1000f*Main.width,29f/1000f*Main.height),"", Main.sty_OffSet_Coo_mini);
		GUI.Label(new Rect(270f/1000f*Main.width,210f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"(0：关断  1：接通 )", Main.sty_MostWords);
		GUI.Label(new Rect(40f/1000f*Main.width,240f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"纸带格式", Main.sty_MostWords);
		GUI.Label(new Rect(220f/1000f*Main.width,240f/1000f*Main.height,20f/1000f*Main.width,300f/1000f*Main.height),"=", Main.sty_MostWords);
		GUI.Label(new Rect(240f/1000f*Main.width,240f/1000f*Main.height,20f/1000f*Main.width,29f/1000f*Main.height),"", Main.sty_OffSet_Coo_mini);
		GUI.Label(new Rect(270f/1000f*Main.width,240f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"(0：无变换 1：F10/11 )", Main.sty_MostWords);
		GUI.Label(new Rect(40f/1000f*Main.width,270f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"顺序号停止", Main.sty_MostWords);
		GUI.Label(new Rect(220f/1000f*Main.width,270f/1000f*Main.height,20f/1000f*Main.width,300f/1000f*Main.height),"=", Main.sty_MostWords);
		GUI.Label(new Rect(240f/1000f*Main.width,270f/1000f*Main.height,120f/1000f*Main.width,29f/1000f*Main.height),"", Main.sty_OffSet_Coo);
		GUI.Label(new Rect(370f/1000f*Main.width,270f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"( 程 序 号 )", Main.sty_MostWords);
		GUI.Label(new Rect(40f/1000f*Main.width,300f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"顺序号停止", Main.sty_MostWords);
		GUI.Label(new Rect(220f/1000f*Main.width,300f/1000f*Main.height,20f/1000f*Main.width,300f/1000f*Main.height),"=", Main.sty_MostWords);
		GUI.Label(new Rect(240f/1000f*Main.width,300f/1000f*Main.height,120f/1000f*Main.width,29f/1000f*Main.height),"", Main.sty_OffSet_Coo);
		GUI.Label(new Rect(370f/1000f*Main.width,300f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"( 顺 序 号 )", Main.sty_MostWords);
		
		GUI.Label(new Rect(241.5f/1000f*Main.width, Main.argu_setting_cursor_y/1000f*Main.height,Main.argu_setting_cursor_w/1000f*Main.width,26f/1000f*Main.height),"", Main.sty_EDITCursor);
		
		GUI.Label(new Rect(240f/1000f*Main.width,60f/1000f*Main.height,20f/1000f*Main.width,29f/1000f*Main.height),CooSystem_script.parameter, Main.sty_SmallNum);
		GUI.Label(new Rect(240f/1000f*Main.width,90f/1000f*Main.height,20f/1000f*Main.width,29f/1000f*Main.height),CooSystem_script.TV, Main.sty_SmallNum);
		GUI.Label(new Rect(240f/1000f*Main.width,120f/1000f*Main.height,20f/1000f*Main.width,29f/1000f*Main.height),CooSystem_script.CKJC, Main.sty_SmallNum);
		GUI.Label(new Rect(240f/1000f*Main.width,150f/1000f*Main.height,20f/1000f*Main.width,29f/1000f*Main.height),CooSystem_script.input_unit, Main.sty_SmallNum);
		GUI.Label(new Rect(240f/1000f*Main.width,180f/1000f*Main.height,40f/1000f*Main.width,29f/1000f*Main.height),CooSystem_script.IO, Main.sty_SmallNum);
		GUI.Label(new Rect(240f/1000f*Main.width,210f/1000f*Main.height,20f/1000f*Main.width,29f/1000f*Main.height),CooSystem_script.order, Main.sty_SmallNum);
		GUI.Label(new Rect(240f/1000f*Main.width,240f/1000f*Main.height,20f/1000f*Main.width,29f/1000f*Main.height),CooSystem_script.zhidai, Main.sty_SmallNum);
		GUI.Label(new Rect(240f/1000f*Main.width,270f/1000f*Main.height,120f/1000f*Main.width,29f/1000f*Main.height),Main.ArguStringGet(CooSystem_script.order_stop1), Main.sty_SmallNum);
		GUI.Label(new Rect(240f/1000f*Main.width,300f/1000f*Main.height,120f/1000f*Main.width,29f/1000f*Main.height),Main.ArguStringGet(CooSystem_script.order_stop2), Main.sty_SmallNum);
